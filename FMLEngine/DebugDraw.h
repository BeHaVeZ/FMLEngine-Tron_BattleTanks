...
namespace FML
{
	...
	public:
		...
		static void DrawFilledRectangle(const glm::vec2& position, const glm::vec2& size, const glm::vec4& color);
	...
	private:
		...
		struct Rectangle { glm::vec2 position, size; glm::vec4 color; bool filled; };
		struct Point { glm::vec2 position; glm::vec4 color; };

		static void ApplyColor(SDL_Renderer* renderer, const glm::vec4& color);
